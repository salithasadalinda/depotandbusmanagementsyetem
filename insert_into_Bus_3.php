...
echo "<table><thead><td>Bus_name</td><td>Starting_point</td><td>Starting_time</td><td>Destination_point</td><td>Destination_time</td><td>Day_of_arrival</td><td>No_of_stations</td><td>Distance</td></thead>";
...
echo "<form action=\"insert_into_Bus_4.php\" method=\"post\">";
$temp=1;
while ($temp<=$ns) 
{
...
{
echo "
<form action=\"insert_into_Bus_3.php\" method=\"post\">
<table>
<tr><td>Bus Name </td><td> <input type=\"text\" name=\"tname\" required></td></tr>
