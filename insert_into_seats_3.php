...
$cdquery="SELECT * FROM Bus where Busno='".$Busno."'";
$cdresult=mysqli_query($conn,$cdquery);			
$cdrow=mysqli_fetch_array($cdresult);

echo "<table><thead><td>Bus_no</td><td>Bus_name</td><td>Starting_point</td><td>Starting_time</td><td>Destination_point</td><td>Destination_time</td><td>Day_of_arrival</td><td>Distance</td><td>Date_Of_Journey</td></thead>";
...
$cdquery="SELECT sname FROM schedule where Busno='".$Busno."' ORDER BY distance ASC  ";
$cdresult=mysqli_query($conn,$cdquery);
$stations=array();
$i=0;
...
<table>
<thead><td>Bus</td><td>Date Of Journey</td></thead>
...
<input type=\"submit\" value=\"Enter Bus Details\">
";
}

echo "<br> <a href=\"dmin_login.php\">Admin privilage</a> ";
